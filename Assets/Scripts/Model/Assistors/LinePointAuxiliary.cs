...
public class LinePointAuxiliary : Auxiliary
{
...
public class LinePointAuxiliaryTool : AuxiliaryTool
{
    public override FormInput FormInput()
    {
        ...
        formInput.inputs[0] = new FormText("作线段");
        formInput.inputs[1] = new FormElement(2);
        formInput.inputs[2] = new FormText("的点");
    ...
    public override Auxiliary GenerateAuxiliary(Geometry geometry, FormInput formInput)
    {
        ...
        LinePointAuxiliary auxiliary = new LinePointAuxiliary(i1, i2, 0.3f, sign);

        return auxiliary;
    }
}

public class LinePointAuxiliaryState : AuxiliaryState
{
    new LinePointAuxiliary auxiliary;
    Geometry geometry;
    ...
    public override FormInput Title()
    {
        ...
        formInput.inputs[1] = new FormText("上的点");
