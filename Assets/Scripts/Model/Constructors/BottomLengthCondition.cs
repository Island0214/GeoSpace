...
public class BottomLengthCondition : TriPyramidBottomCondition
{
...
public class BottomLengthConditionTool : TriPyramidConditionTool
{
...
public class BottomLengthConditionState : ConditionState
{
    new BottomLengthCondition condition;
    TriPyramid geometry;
