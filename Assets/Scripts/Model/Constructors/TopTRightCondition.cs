...
public class TopTRightCondition : TriPyramidTopCondition
{
...
public class TopTRightConditionTool : TriPyramidConditionTool
{
...
public class TopTRightConditionState : ConditionState
{
    new TopTRightCondition condition;
    TriPyramid geometry;
